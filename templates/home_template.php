<section style="background: url(../img/banner2.jpg)" class="py-5 bg-cover bg-center">
    <div class="hero-overlay"></div>
    <div class="container py-5 px-0 text-white text-left">
        <h1 class="text-shadow hero-heading font-weight-normal">Claybrook Zoo</h1>
    ...
    <div class="container-fluid p-5 pb-2">
        <div class="row px-2">
            <div class="col-lg-6 col-sm-12">
                <h2>Welcome to <span class="font-weight-bold text-light-green">Claybrook Zoo</span></h2>
                <div style="width: 8%">
            ...
            <div class="col-lg-6 col-sm-12 mt-sm-4">
                <div class="row">
                    <div class="col">
                        <img src="../img/red_panda_homepage.jpg" alt="" class="img-fluid mb-4" width="200px">
                        <h4 class="h5 mb-2">Red Panda</h4>
                        <p class="text-small text-muted">ellentesque habitant morbi tristique senectus et netus et malesuada fame.</p>
                    </div>
                    <div class="col">
                        <img src="../img/red_panda_homepage.jpg" alt="" class="img-fluid mb-4" width="200px">
                        <h4 class="h5 mb-2">Red Panda</h4>
        ...
        <div class="row justify-content-center">
            <?php foreach ($testimonials as $testimonial) { ?>
                <div class="col-lg-4 col-sm-10 text-center mb-sm-4">
                    <div class="">
                        <img src="../img/sponsor_homepage.jpg" alt="" width="195px" style="border-radius: 50%; border: 10px solid #3E7331">
                    </div>
            ...
            <div class="col">
                ...
                <div class="row">
                    <div class="col-xs-10 col-lg-6">
                        <img src="../img/zoo_map.bmp" alt="" width="90%">
                    </div>
